(ns metabase-enterprise.semantic-layer.task.complexity-score-trimmer
...
(def ^:private job-key
  (jobs/key "metabase-enterprise.semantic-layer.task.complexity-score-trimmer.job"))

(def ^:private trigger-key
  (triggers/key "metabase-enterprise.semantic-layer.task.complexity-score-trimmer.trigger"))
