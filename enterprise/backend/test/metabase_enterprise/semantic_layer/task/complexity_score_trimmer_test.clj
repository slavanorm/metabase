(ns metabase-enterprise.semantic-layer.task.complexity-score-trimmer-test
  (:require
   [clojure.test :refer :all]
   [java-time.api :as t]
   [metabase-enterprise.semantic-layer.task.complexity-score-trimmer :as complexity-score-trimmer]
   [metabase.test :as mt]
